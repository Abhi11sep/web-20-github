...
const Javascript = () => {
    ...
    const getData = async (page) => {
        return fetch(`https://api.github.com/search/repositories?q=stars:%3E1+language:javascript&sort:stargazers_count-desc&page=${page}&per_page=10`)
  ...
  return (
    <div style={{width:"100%"}}>
    <h1>All JAVASCRIPT Repositories</h1>
    <div className='main'>
       {data.map((item) => (
