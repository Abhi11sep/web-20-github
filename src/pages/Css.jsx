...
const Css = () => {
    ...
    const getData = async (page) => {
        return fetch(`https://api.github.com/search/repositories?q=stars:%3E1+language:css&sort:stargazers_count-desc&page=${page}&per_page=10`)
